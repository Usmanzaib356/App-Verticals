...
function Industries() {
  const [selectedImage, setSelectedImage] = useState(
    'https://www.appverticals.com/_next/image?url=%2Fnext%2Fhome%2Findustries%2Fenqueue.webp&w=640&q=75'
  );
    ...
    <>
      <div className="industry-sec">
        <div className="cards-text">
          ...
          <h2 className=" Our-Proficient">
            Custom Industry Development Service
          </h2>
            ...
            {data.map((item, i) => {
              return (
                <div
                  ...
                  onClick={() => handleChangeImage(item.heroImg)}
                >
